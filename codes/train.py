...
def _main():
    annotation_path = 'constitution.txt'
    log_dir = 'logs/000/'
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='model_data/GeorgeIV.h5') # make sure you know what you freeze
    ...
    if True:
        ...
        model.save_weights(log_dir + 'GeorgeIV.h5')
